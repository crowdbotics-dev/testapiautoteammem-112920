...
## Project Structure
    ...
    ├── testapiautoteammem_112920  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112920`
...
2. Clone this repo and `cd testapiautoteammem_112920`
